      ...
      <v-list dense>
        ...
        <template>
          <v-list-group>
            ...
            <v-list-item :to="{ name: 'cuentacontable'}">
              <v-list-item-action>
                <v-icon>table_chart</v-icon>
              </v-list-item-action>
              <v-list-item-content>
        ...
        <template>
          <v-list-group>
            ...
            <v-list-item :to="{ name: 'grpconceptos'}">
              <v-list-item-action>
                <v-icon>table_chart</v-icon>
              </v-list-item-action>
              <v-list-item-content>
